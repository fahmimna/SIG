  ...
  <div class="container">
    <div class="row fullscreen align-items-center justify-content-between">
      <div class="col-lg-6 col-md-6 banner-left">
        <h6 class="text-white">SISTEM LBS WISATA</h6>
        <h1 class="text-white">KABUPATEN SLEMAN</h1>
        <p class="text-white">
          Sistem informasi ini merupakan layanan berbasis lokasi wisata di wilayah Sleman. Aplikasi ini memuat informasi dan lokasi dari tempat wisata di Sleman.
        </p>
        ...
        <div class="row align-items-center">
          ...
          <script type="text/javascript">
            function initialize() {
              ...
              var mapOptions = {
                zoom: 10.2,
                center: new google.maps.LatLng(-7.689355, 110.2411863),
      ...
      <div class="row d-flex justify-content-center">
        <div class="menu-content pb-70 col-lg-8">
          <div class="title text-center">
            ...
            <p>Layanan berbasis Lokasi Wisata di Kabupaten Sleman ini memuat informasi dan lokasi dari Wisata ALam dan WIsata Kuliner di Sleman. Pemetaan diambil dari data lokasi Google Maps dan data dari website masing-masing tempat wisata. Aplikasi ini memuat sejumlah informasi mengenai :
            </p>
          </div>
        </div>
      </div>

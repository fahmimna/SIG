    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <br>
                <br>
                <center><img src="img/sleman.png" alt="slemanlogo" width="150px"> </center>
                <br>
                <h2>
                    <center><b>LOCATION BASED SERVICE </b> </center>
                </h2>
                <h2>
                    <center><b>OBJEK WISATA KABUPATEN SLEMAN </b> </center>
                </h2>
                <h2>
